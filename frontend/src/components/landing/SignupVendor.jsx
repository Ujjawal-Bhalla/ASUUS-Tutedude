// src/components/landing/SignupVendor.jsx
import React, { useState } from 'react';
import { User, Mail, Lock, Phone, MapPin, X, Loader2, CheckCircle } from 'lucide-react';

export default function SignupVendor({ onClose, language }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3000/api/auth/register', {
        ...
        body: JSON.stringify({
          ...formData,
          role: 'buyer', // Vendor is buyer in our system
        ...
        <div className="p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
